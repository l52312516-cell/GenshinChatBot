...
![控制台](docs/screenshots/control-center.png)

![识图引擎](docs/screenshots/ocr.png)

![AI 配置](docs/screenshots/ai.png)

![机器人配置](docs/screenshots/bot.png)

![依赖与环境](docs/screenshots/dependencies.png)

![插件](docs/screenshots/plugins.png)
